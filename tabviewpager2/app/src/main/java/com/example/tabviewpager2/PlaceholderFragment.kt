...
class PlaceholderFragment:Fragment() {
    companion object{
        ...
        @JvmStatic
        fun newInstance(name: String, background:Int):PlaceholderFragment{
            return PlaceholderFragment().apply {
                arguments = Bundle().apply {
                    putString(FRAGMENT_NAME,name)
                    putInt(BACKGROUND_COLOR,background)
                }
            }
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        arguments?.let {
            view.findViewById<TextView>(R.id.fragment_name).text = it.getString(FRAGMENT_NAME,"Sem Nome")
